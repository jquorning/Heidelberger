...
--        global (x_nav_menu_placeholder, Nav_Menu_Selected_Id);
   begin
      ...
      Echo ("<div class=""customlinkdiv"" id=""customlinkdiv"">");
      Echo ("    <input type=""hidden"" value=""custom"" " &
            "name=""menu-item(" & X_Nav_Menu_Placeholder & ")(menu-item-type)"" />");
      Echo ("    <p id=""menu-item-url-wrap"" class=""wp-clearfix"">");
      Echo ("    <label class=""howto"" for=""custom-menu-item-url"">" &
            X_E ("URL") & "</label>");
      Echo ("    <input id=""custom-menu-item-url"" name=""menu-item(" &
            X_Nav_Menu_Placeholder & ")(menu-item-url)"" type=""text""" &
            Wp_Nav_Menu_Disabled_Check (Nav_Menu_Selected_Id) &
            """ class=""code menu-item-textbox form-required"" " &
            "placeholder=""https: *"" />");
      Echo ("    </p>");

      Echo ("    <p id=""menu-item-name-wrap"" class=""wp-clearfix"">");
      Echo ("    <label class=""howto"" for=""custom-menu-item-name"">" &
            X_E ("Link Text") & "</label>");
      Echo ("    <input id=""custom-menu-item-name"" name=""menu-item(" &
            X_Nav_Menu_Placeholder & ")(menu-item-title)"" type=""text""" &
            Wp_Nav_Menu_Disabled_Check (Nav_Menu_Selected_Id) &
...
--       then Absint (Get_Integer (X_REQUEST, "paged")) else 1);
      ...
      --
      Important_Pages   : constant List_Type := Empty_List;
