...
-- }
   ...
   function Get_Editable_Roles return Array_Type is
      use Wp_Common;
      use Inc_Roles;

      All_Roles : constant Array_Type := Inc_Roles.Global_Wp_Roles.Roles;
