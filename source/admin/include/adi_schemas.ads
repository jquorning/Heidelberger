...
-- --
-- function wp_get_db_schema( scope = "all", blog_id = null ) then
--         global wpdb;

--         charset_collate = wpdb->get_charset_collate();

--         if ( blog_id && blog_id != wpdb->blogid ) then
...
--         end; elseif ( offset_or_tz && in_array( offset_or_tz, timezone_identifiers_list( DateTimeZone::ALL_WITH_BC ), true ) ) then
...
--         foreach ( options as option => value ) then
--                 if ( in_array( option, existing_options, true ) ) then
--                         continue;
--                 end;

--                 if ( in_array( option, fat_options, true ) ) then
--                         autoload = "no";
--                 end; else then
--                         autoload = "yes";
--                 end;
...
--                 "advanced_edit",
--         );
--         foreach ( unusedoptions as option ) then
--                 delete_option( option );
--         end;

--         // Delete obsolete magpie stuff.
--         wpdb->query( "DELETE FROM wpdb->options WHERE option_name REGEXP "^rss_[0-9a-f]then32end;(_ts)?"" );
...
-- -- @since 2.0.0
-- --
-- function populate_roles_160() then
--         // Add roles.
...
-- -- @since 2.1.0
-- --
-- function populate_roles_210() then
--         roles = array( "administrator", "editor" );
--         foreach ( roles as role ) then
--                 role = get_role( role );
--                 if ( empty( role ) ) then
--                         continue;
--                 end;
...
-- -- @since 2.3.0
-- --
-- function populate_roles_230() then
--         role = get_role( "administrator" );
...
-- -- @since 2.5.0
-- --
-- function populate_roles_250() then
--         role = get_role( "administrator" );
...
-- -- @since 2.6.0
-- --
-- function populate_roles_260() then
--         role = get_role( "administrator" );
...
-- -- @since 2.7.0
-- --
-- function populate_roles_270() then
--         role = get_role( "administrator" );
...
-- -- @since 2.8.0
-- --
-- function populate_roles_280() then
--         role = get_role( "administrator" );
...
-- -- @since 3.0.0
-- --
-- function populate_roles_300() then
--         role = get_role( "administrator" );
