...
is
   ...
   begin
      ...
      Printf (
        ...
        [1 => abs "https://wordpress.org/about/license/"]
      );
      Echo ("    </p>");
      Echo ("</div>");
      ...
      Echo ("        <img class=""freedom-image"" src=""");
      Echo (ESC_URL (Admin_URL ("images/freedom-1.svg?ver=6.5")));
      Echo (""" alt="""" />");
      ...
      Echo ("    <div class=""column aligncenter"">");
      Echo ("        <img class=""freedom-image"" src=""");
      Echo (ESC_URL (Admin_URL ("images/freedom-2.svg?ver=6.5")));
      Echo (""" alt="""" />");
      ...
      Echo ("    <div class=""column aligncenter"">");
      Echo ("        <img class=""freedom-image"" src=""");
      Echo (ESC_URL (Admin_URL ("images/freedom-3.svg?ver=6.5")));
      Echo (""" alt="""" />");
      ...
      Echo ("    <div class=""column aligncenter"">");
      Echo ("        <img class=""freedom-image"" src=""");
      Echo (ESC_URL (Admin_URL ("images/freedom-4.svg?ver=6.5")));
      Echo (""" alt="""" />");
      ...
      Echo ("        <p>");
      declare
         Plugins_URL : constant String :=
           (if Current_User_Can ("activate_plugins")
            then Admin_URL ("plugins.php")
            else abs "https://wordpress.org/plugins/");
         Themes_URL  : constant String :=
           (if Current_User_Can ("switch_themes")
            then Admin_URL ("themes.php")
            else abs "https://wordpress.org/themes/");
      begin
         Printf (
