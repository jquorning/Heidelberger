...
package body HB_Server is
   ...
   begin
      ...
      Register (Dispatcher, "/wp-admin/contribute.php", Binder.Render'Access);
      ...
      Register (Dispatcher, "/wp-admin/plugin-install.php", Binder.Render'Access);
      ...
      Register (Dispatcher, "/wp-admin/options-general.php", Binder.Render'Access);
