...
for Filter of To_List ((+"pre_term_name", +"pre_comment_author_name", +"pre_link_name", +"pre_link_target", +"pre_link_rel", +"pre_user_display_name", +"pre_user_first_name", +"pre_user_last_name", +"pre_user_nickname"))
    loop
...
for Filter of To_List ((+"term_name", +"comment_author_name", +"link_name", +"link_target", +"link_rel", +"user_display_name", +"user_first_name", +"user_last_name", +"user_nickname"))
    loop
        if Is_Admin then
...
for Filter of To_List ((+"pre_term_description", +"pre_link_description", +"pre_link_notes", +"pre_user_description")) loop
        Add_Filter (Filter, "wp_filter_kses");
end loop;

-- Kses only for textarea admin displays.
if Is_Admin then
        for Filter of To_Array (+"term_description", +"link_description", +"link_notes", +"user_description")) loop
                Add_Filter (Filter, "wp_kses_data");
        end loop;
...
-- Display URL.
for Filter of To_List ((+"user_url", +"link_url", +"link_image", +"link_rss", +"comment_url", +"post_guid")) loop
        if Is_Admin then
                Add_Filter (Filter, "wp_strip_all_tags");
        end if;
...
-- Keys.
for Filter of To_List ((+"pre_post_type", +"pre_post_status", +"pre_post_comment_status", +"pre_post_ping_status")) loop
...
for Filter of To_List ((+"content_save_pre", +"excerpt_save_pre", +"comment_save_pre", +"pre_comment_content")) loop
...
for Filter of To_List ((+"comment_author", +"term_name", +"link_name", +"link_description", +"link_notes", +"bloginfo", +"wp_title", +"document_title", +"widget_title")) loop
...
-- Format WordPress.
for Filter of To_List (+"the_content", +"the_title", +"wp_title", +"document_title")) loop
        Add_Filter (Filter, "capital_P_dangit", 11);
end loop;
Add_Filter ("comment_text", "capital_P_dangit", 31);

-- Format titles.
for Filter of To_List ((+"single_post_title", +"single_cat_title", +"single_tag_title", +"single_month_title", +"nav_menu_attr_title", +"nav_menu_description")) loop
        Add_Filter (Filter, "wptexturize");
        Add_Filter (Filter, "strip_tags");
end loop;

-- Format text area for display.
for Filter of To_List ((+"term_description", +"get_the_post_type_description")) loop
        Add_Filter (Filter, "wptexturize");
        Add_Filter (Filter, "convert_chars");
...
-- Feed generator tags.
for Action of To_List ((+"rss2_head", +"commentsrss2_head", +"rss_head", +"rdf_header", +"atom_head", +"comments_atom_head", +"opml_head", +"app_head")) loop
