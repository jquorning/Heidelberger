...
package Inc_Comments_Templates
is
...
-- --
-- function get_comment_author( comment_ID = 0 ) then
--         comment    = get_comment( comment_ID );
--         comment_ID = ! empty( comment.comment_ID ) ? comment.comment_ID : comment_ID;

--         if ( empty( comment.comment_author ) ) then
...
-- --                                   Default current comment.
-- --
-- function comment_author( comment_ID = 0 ) then
--         comment = get_comment( comment_ID );
...
-- --
-- function get_comment_author_email( comment_ID = 0 ) then
--         comment = get_comment( comment_ID );
...
-- --                                   Default current comment.
-- --
-- function comment_author_email( comment_ID = 0 ) then
--         comment      = get_comment( comment_ID );
...
-- --
-- function comment_author_email_link( linktext = "", before = "", after = "", comment = null ) then
...
-- --                via the then@see "comment_email"end; filter with antispambot().
-- --
-- function get_comment_author_email_link( linktext = "", before = "", after = "", comment = null ) then
...
--         if ( ( ! empty( email ) ) && ( "@" !== email ) ) then
--                 display = ( "" !== linktext ) ? linktext : email;
--                 return  = before;
--                 return .= sprintf( "<a href="%1s">%2s</a>", esc_url( "mailto:" . email ), esc_html( display ) );
--                 return .= after;
--                 return return;
--         end; else then
--                 return "";
...
-- --
-- function get_comment_author_link( comment_ID = 0 ) then
--         comment = get_comment( comment_ID );
--         url     = get_comment_author_url( comment );
--         author  = get_comment_author( comment );

--         if ( empty( url ) || "http://" === url ) then
--                 return = author;
--         end; else then
...
-- --                                   Default current comment.
-- --
-- function comment_author_link( comment_ID = 0 ) then
...
-- --
-- function get_comment_author_IP( comment_ID = 0 ) then // phpcs:ignore WordPress.NamingConventions.ValidFunctionName.FunctionNameInvalid
--         comment = get_comment( comment_ID );
...
-- --                                   Default current comment.
-- --
-- function comment_author_IP( comment_ID = 0 ) then // phpcs:ignore WordPress.NamingConventions.ValidFunctionName.FunctionNameInvalid
...
-- --
-- function get_comment_author_url( comment_ID = 0 ) then
--         comment = get_comment( comment_ID );
--         url     = "";
--         id      = 0;
...
-- --                                   Default current comment.
-- --
-- function comment_author_url( comment_ID = 0 ) then
--         comment    = get_comment( comment_ID );
...
-- --
-- function get_comment_author_url_link( linktext = "", before = "", after = "", comment = 0 ) then
--         url     = get_comment_author_url( comment );
--         display = ( "" !== linktext ) ? linktext : url;
--         display = str_replace( "http://www.", "", display );
--         display = str_replace( "http://", "", display );

--         if ( "/" === substr( display, -1 ) ) then
...
-- --                                 Default is the current comment.
-- --
-- function comment_author_url_link( linktext = "", before = "", after = "", comment = 0 ) then
...
-- --
-- function comment_class( css_class = "", comment = null, post = null, display = true ) then
...
-- --
-- function get_comment_class( css_class = "", comment_id = null, post = null ) then
...
--                 _post = get_post( post );
--                 if ( _post ) then
--                         if ( comment.user_id === _post.post_author ) then
--                                 classes[] = "bypostauthor";
--                         end;
--                 end;
--         end;

--         if ( empty( comment_alt ) ) then
--                 comment_alt = 0;
--         end;
--         if ( empty( comment_depth ) ) then
--                 comment_depth = 1;
--         end;
--         if ( empty( comment_thread_alt ) ) then
--                 comment_thread_alt = 0;
--         end;

--         if ( comment_alt % 2 ) then
--                 classes[] = "odd";
--                 classes[] = "alt";
--         end; else then
--                 classes[] = "even";
...
--         if ( 1 == comment_depth ) then
--                 if ( comment_thread_alt % 2 ) then
--                         classes[] = "thread-odd";
--                         classes[] = "thread-alt";
--                 end; else then
--                         classes[] = "thread-even";
...
-- --
-- function get_comment_date( format = "", comment_ID = 0 ) then
--         comment = get_comment( comment_ID );
...
-- --                                   Default current comment.
-- --
-- function comment_date( format = "", comment_ID = 0 ) then
...
-- --
-- function get_comment_excerpt( comment_ID = 0 ) then
--         comment = get_comment( comment_ID );

--         if ( ! post_password_required( comment.comment_post_ID ) ) then
...
-- --                                    Default current comment.
-- --
-- function comment_excerpt( comment_ID = 0 ) then
--         comment         = get_comment( comment_ID );
...
-- --
-- function get_comment_ID() then // phpcs:ignore WordPress.NamingConventions.ValidFunctionName.FunctionNameInvalid
--         comment    = get_comment();
...
-- -- @since 0.71
-- --
-- function comment_ID() then // phpcs:ignore WordPress.NamingConventions.ValidFunctionName.FunctionNameInvalid
--         echo get_comment_ID();
-- end;
...
-- --
-- function get_comment_link( comment = null, args = array() ) then
...
--         if ( ! is_null( args["cpage"] ) ) then
--                 cpage = args["cpage"];

--                 // No "cpage" is provided, so we calculate one.
--         end; else then
--                 if ( "" === args["per_page"] && get_option( "page_comments" ) ) then
...
--                 --
--                 if ( "oldest" === get_option( "default_comments_page" ) && 1 === cpage ) then
--                         cpage = "";
--                 end;
--         end;

--         if ( cpage && get_option( "page_comments" ) ) then
...
-- --
-- function get_comments_link( post = 0 ) then
...
-- --
-- function comments_link( deprecated = "", deprecated_2 = "" ) then
--         if ( ! empty( deprecated ) ) then
--                 _deprecated_argument( __FUNCTION__, "0.72" );
--         end;
--         if ( ! empty( deprecated_2 ) ) then
...
-- --
-- function get_comments_number( post = 0 ) then
--         post = get_post( post );
...
-- -- @param int|WP_Post  post Optional. Post ID or WP_Post object. Default is the global `post`.
-- --
-- function comments_number( zero = false, one = false, more = false, post = 0 ) then
...
-- --
-- function get_comments_number_text( zero = false, one = false, more = false, post = 0 ) then
...
--                         --
--                         if ( "on" === _x( "off", "Comment number declension: on or off" ) ) then
--                                 text = preg_replace( "#<span class="screen-reader-text">.+?</span>#", "", more );
--                                 text = preg_replace( "/&.+?;/", "", text ); // Kill entities.
--                                 text = trim( strip_tags( text ), "% " );

--                                 // Replace "% Comments" with a proper plural form.
--                                 if ( text && ! preg_match( "/[0-9]+/", text ) && false !== strpos( more, "%" ) ) then
--                                         /* translators: %s: Number of comments.--
--                                         new_text = _n( "%s Comment", "%s Comments", number );
--                                         new_text = trim( sprintf( new_text, "" ) );

--                                         more = str_replace( text, new_text, more );
--                                         if ( false === strpos( more, "%" ) ) then
--                                                 more = "% " . more;
--                                         end;
--                                 end;
--                         end;
...
--                 end;
--         end; elseif ( 0 == number ) then
--                 output = ( false === zero ) ? __( "No Comments" ) : zero;
--         end; else then // Must be one.
...
-- --
-- function get_comment_text( comment_ID = 0, args = array() ) then
--         comment = get_comment( comment_ID );

--         comment_content = comment.comment_content;

--         if ( is_comment_feed() && comment.comment_parent ) then
...
-- -- @param array          args       Optional. An array of arguments. Default empty array.
-- --
-- function comment_text( comment_ID = 0, args = array() ) then
--         comment = get_comment( comment_ID );
...
-- --
-- function get_comment_time( format = "", gmt = false, translate = true ) then
--         comment = get_comment();
...
-- -- @param string format Optional. PHP time format. Defaults to the "time_format" option.
-- --
-- function comment_time( format = "" ) then
...
-- --
-- function get_comment_type( comment_ID = 0 ) then
--         comment = get_comment( comment_ID );

--         if ( "" === comment.comment_type ) then
...
-- --
-- function comment_type( commenttxt = false, trackbacktxt = false, pingbacktxt = false ) then
--         if ( false === commenttxt ) then
--                 commenttxt = _x( "Comment", "noun" );
--         end;
--         if ( false === trackbacktxt ) then
--                 trackbacktxt = __( "Trackback" );
--         end;
--         if ( false === pingbacktxt ) then
...
-- --
-- function get_trackback_url() then
...
-- --
-- function trackback_url( deprecated_echo = true ) then
--         if ( true !== deprecated_echo ) then
...
-- --
-- function trackback_rdf( deprecated = "" ) then
--         if ( ! empty( deprecated ) ) then
--                 _deprecated_argument( __FUNCTION__, "2.5.0" );
--         end;

--         if ( isset( _SERVER["HTTP_USER_AGENT"] ) && false !== stripos( _SERVER["HTTP_USER_AGENT"], "W3C_Validator" ) ) then
--                 return;
--         end;
...
-- -- @since 2.1.3
-- --
-- function wp_comment_form_unfiltered_html_nonce() then
--         post    = get_post();
--         post_id = post ? post.ID : 0;

--         if ( current_user_can( "unfiltered_html" ) ) then
--                 wp_nonce_field( "unfiltered-html-comment_" . post_id, "_wp_unfiltered_html_comment_disabled", false );
--                 echo "<script>(function()thenif(window===window.parent)thendocument.getElementById("_wp_unfiltered_html_comment_disabled").name="_wp_unfiltered_html_comment";end;end;)();</script>\n";
--         end;
-- end;
...
-- -- are passed through the then@see "comments_array"end; filter hook with the list of comments
-- -- and the post ID respectively.
-- --
-- -- The `file` path is passed through a filter hook called then@see "comments_template"end;,
...
-- --                                  Default false.
-- --
-- function comments_template( file = "/comments.php", separate_comments = false ) then
--         global wp_query, withcomments, post, wpdb, id, comment, user_login, user_identity, overridden_cpage;

--         if ( ! ( is_single() || is_page() || withcomments ) || empty( post ) ) then
--                 return;
--         end;
...
--                 end; elseif ( "oldest" === get_option( "default_comments_page" ) ) then
...
--                         if ( comment_args["hierarchical"] ) then
--                                 top_level_args["parent"] = 0;
--                         end;

--                         if ( isset( comment_args["include_unapproved"] ) ) then
...
--                         --
--                         -- @param array top_level_args then
...
--         if ( comment_args["hierarchical"] ) then
--                 comments_flat = array();
--                 foreach ( _comments as _comment ) then
...
--                         foreach ( comment_children as comment_child ) then
...
--         if ( "" == get_query_var( "cpage" ) && wp_query.max_num_comment_pages > 1 ) then
--                 set_query_var( "cpage", "newest" === get_option( "default_comments_page" ) ? get_comment_pages_count() : 1 );
--                 overridden_cpage = true;
--         end;

--         if ( ! defined( "COMMENTS_TEMPLATE" ) ) then
...
--         if ( file_exists( include ) ) then
--                 require include;
--         end; elseif ( file_exists( TEMPLATEPATH . file ) ) then
--                 require TEMPLATEPATH . file;
--         end; else then // Backward compat code will be removed in a future release.
...
-- --
-- function comments_popup_link( zero = false, one = false, more = false, css_class = "", none = false ) then
--         post_id    = get_the_ID();
...
--                 more = _n( "%1s Comment<span class="screen-reader-text"> on %2s</span>", "%1s Comments<span class="screen-reader-text"> on %2s</span>", number );
...
--         if ( 0 == number && ! comments_open() && ! pings_open() ) then
...
-- --
-- function get_comment_reply_link( args = array(), comment = null, post = null ) then
--         defaults = array(
--                 "add_below"     => "comment",
--                 "respond_id"    => "respond",
--                 "reply_text"    => __( "Reply" ),
...
--         if ( 0 == args["depth"] || args["max_depth"] <= args["depth"] ) then
--                 return;
--         end;
...
--         if ( get_option( "comment_registration" ) && ! is_user_logged_in() ) then
--                 link = sprintf(
...
--                 foreach ( data_attributes as name => value ) then
--                         data_attribute_string .= " data-thennameend;=\"" . esc_attr( value ) . """;
--                 end;
...
-- --                                Default current post.
-- --
-- function comment_reply_link( args = array(), comment = null, post = null ) then
...
-- -- @return string|false|null Link to show comment form, if successful. False, if comments are closed.
-- --
-- function get_post_reply_link( args = array(), post = null ) then
--         defaults = array(
--                 "add_below"  => "post",
--                 "respond_id" => "respond",
...
--         end; else then
--                 onclick = sprintf(
--                         "return addComment.moveForm( "%1s-%2s", "0", "%3s", "%2s" )",
--                         args["add_below"],
--                         post.ID,
--                         args["respond_id"]
--                 );
...
-- --                          Default current post.
-- --
-- function post_reply_link( args = array(), post = null ) then
...
-- -- @return string
-- --
-- function get_cancel_comment_reply_link( text = "" ) then
--         if ( empty( text ) ) then
...
-- --                     defaults to "Click here to cancel reply". Default empty.
-- --
-- function cancel_comment_reply_link( text = "" ) then
...
-- --
-- function get_comment_id_fields( post_id = 0 ) then
...
-- -- @param int post_id Optional. Post ID. Defaults to the current post ID.
-- --
-- function comment_id_fields( post_id = 0 ) then
...
-- --
-- function comment_form_title( no_reply_text = false, reply_text = false, link_to_parent = true ) then
--         global comment;

--         if ( false === no_reply_text ) then
--                 no_reply_text = __( "Leave a Reply" );
--         end;

--         if ( false === reply_text ) then
...
--         if ( 0 == reply_to_id ) then
--                 echo no_reply_text;
--         end; else then
--                 // Sets the global so that template tags can be used in the comment form.
--                 comment = get_comment( reply_to_id );

--                 if ( link_to_parent ) then
...
-- --
-- function wp_list_comments( args = array(), comments = null ) then
...
--                         return;
--                 end;
--                 if ( "all" !== parsed_args["type"] ) then
--                         comments_by_type = separate_comments( comments );
--                         if ( empty( comments_by_type[ parsed_args["type"] ] ) ) then
--                                 return;
--                         end;
...
--                 --
--                 if ( parsed_args["page"] || parsed_args["per_page"] ) then
--                         current_cpage = get_query_var( "cpage" );
--                         if ( ! current_cpage ) then
--                                 current_cpage = "newest" === get_option( "default_comments_page" ) ? 1 : wp_query.max_num_comment_pages;
--                         end;

--                         current_per_page = get_query_var( "comments_per_page" );
--                         if ( parsed_args["page"] != current_cpage || parsed_args["per_page"] != current_per_page ) then
--                                 comment_args = array(
--                                         "post_id" => get_the_ID(),
--                                         "orderby" => "comment_date_gmt",
--                                         "order"   => "ASC",
...
--                 end; else then
--                         if ( empty( wp_query.comments ) ) then
--                                 return;
--                         end;
--                         if ( "all" !== parsed_args["type"] ) then
--                                 if ( empty( wp_query.comments_by_type ) ) then
--                                         wp_query.comments_by_type = separate_comments( wp_query.comments );
--                                 end;
--                                 if ( empty( wp_query.comments_by_type[ parsed_args["type"] ] ) ) then
--                                         return;
--                                 end;
...
--                         if ( wp_query.max_num_comment_pages ) then
--                                 default_comments_page = get_option( "default_comments_page" );
--                                 cpage                 = get_query_var( "cpage" );
--                                 if ( "newest" === default_comments_page ) then
...
--         if ( "" === parsed_args["per_page"] && get_option( "page_comments" ) ) then
--                 parsed_args["per_page"] = get_query_var( "comments_per_page" );
--         end;

--         if ( empty( parsed_args["per_page"] ) ) then
--                 parsed_args["per_page"] = 0;
--                 parsed_args["page"]     = 0;
--         end;

--         if ( "" === parsed_args["max_depth"] ) then
--                 if ( get_option( "thread_comments" ) ) then
...
--         if ( "" === parsed_args["page"] ) then
--                 if ( empty( overridden_cpage ) ) then
...
--         if ( 0 == parsed_args["page"] && 0 != parsed_args["per_page"] ) then
--                 parsed_args["page"] = 1;
--         end;

--         if ( null === parsed_args["reverse_top_level"] ) then
--                 parsed_args["reverse_top_level"] = ( "desc" === get_option( "comment_order" ) );
--         end;

--         wp_queue_comments_for_comment_meta_lazyload( _comments );

--         if ( empty( parsed_args["walker"] ) ) then
...
-- -- into the function, while you may also choose to use the then@see "comment_form_default_fields"end;
-- -- filter to modify the array of default fields if you"d just like to add a new
-- -- one or remove a single field. All fields are also individually passed through
-- -- a filter of the then@see "comment_form_field_name"end; where `name` is the key used
...
-- --
-- --     @type array fields then
-- --         Default comment fields, filterable by default via the then@see "comment_form_default_fields"end; hook.
-- --
...
-- --                                        Default: "<input name="%1s" type="submit" id="%2s" class="%3s" value="%4s" />".
-- --     @type string submit_field         HTML format for the markup surrounding the Submit button and comment hidden
-- --                                        fields. Default: "<p class="form-submit">%1s %2s</p>", where %1s is the
-- --                                        submit button markup and %2s is the comment hidden fields.
-- --     @type string format               The comment form format. Default "xhtml". Accepts "xhtml", "html5".
-- -- end;
-- -- @param int|WP_Post post Post ID or WP_Post object to generate the form for. Default current post.
-- --
-- function comment_form( args = array(), post = null ) then
--         post = get_post( post );

--         // Exit the function if the post is invalid or comments are closed.
--         if ( ! post || ! comments_open( post ) ) then
--                 --
...
--         if ( has_action( "set_comment_cookies", "wp_set_comment_cookies" ) && get_option( "show_comments_cookies_opt_in" ) ) then
...
--                 if ( isset( args["fields"] ) && ! isset( args["fields"]["cookies"] ) ) then
...
--                                 __( "Logged in as %1s. <a href="%2s">Edit your profile</a>. <a href="%3s">Log out?</a>" ),
--                                 user_identity,
--                                 get_edit_user_link(),
--                                 -- This filter is documented in wp-includes/link-template.php--
...
--                 "submit_button"        => "<input name="%1s" type="submit" id="%2s" class="%3s" value="%4s" />",
--                 "submit_field"         => "<p class="form-submit">%1s %2s</p>",
--                 "format"               => "xhtml",
--         );
...
--         --
--         -- Use then@see "comment_form_default_fields"end; to filter the comment fields.
--         --
--         -- @since 3.0.0
--         --
...
--         if ( isset( args["fields"]["email"] ) && false === strpos( args["comment_notes_before"], "id="email-notes"" ) ) then
...
--                         foreach ( comment_fields as name => field ) then
...
--                                         --
--                                         echo apply_filters( "comment_form_field_thennameend;", field ) . "\n";

--                                         if ( last_field === name ) then
--                                                 --
