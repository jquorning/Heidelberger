...
is
   ...
   --
   procedure Wp (Query_Vars : Array_Type := Empty_Array); -- String := ""
   ...
   -- @param string      operator Optional. The logical operation to perform. "AND"
   --                             means all elements from the array must match. "OR"
   --                             means only one element needs to match. "NOT" means
   --                             no elements may match. Default "AND".
