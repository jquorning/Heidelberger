...
-- --
-- function get_header( name = null, args = array() ) then
--         --
...
--         name      = (string) name;
--         if ( "" !== name ) then
--                 templates[] = "header-thennameend;.php";
--         end;

--         templates[] = "header.php";

--         if ( ! locate_template( templates, true, true, args ) ) then
--                 return false;
--         end;
-- end;
...
-- -- @return void|false Void on success, false if the template does not exist.
-- --
-- function get_footer( name = null, args = array() ) then
--         --
...
--         name      = (string) name;
--         if ( "" !== name ) then
--                 templates[] = "footer-thennameend;.php";
--         end;
...
-- -- @return void|false Void on success, false if the template does not exist.
-- --
-- function get_sidebar( name = null, args = array() ) then
--         --
...
--         name      = (string) name;
--         if ( "" !== name ) then
--                 templates[] = "sidebar-thennameend;.php";
--         end;
...
-- -- specialised part will be included. If the theme contains no thenslugend;.php file
-- -- then no template will be included.
-- --
-- -- The template is included using require, not require_once, so you may include the
-- -- same template part multiple times.
-- --
-- -- For the name parameter, if the file is called "thenslugend;-special.php" then specify
-- -- "special".
-- --
-- -- @since 3.0.0
-- -- @since 5.5.0 A return value was added.
...
-- -- @return void|false Void on success, false if the template does not exist.
-- --
-- function get_template_part( slug, name = null, args = array() ) then
--         --
...
--         --
--         do_action( "get_template_part_thenslugend;", slug, name, args );

--         templates = array();
--         name      = (string) name;
--         if ( "" !== name ) then
--                 templates[] = "thenslugend;-thennameend;.php";
--         end;

--         templates[] = "thenslugend;.php";
...
--         if ( ! locate_template( templates, true, false, args ) ) then
--                 return false;
--         end;
-- end;
...
-- --
-- function get_search_form( args = array() ) then
--         --
...
--         if ( "" !== search_form_template ) then
--                 ob_start();
--                 require search_form_template;
--                 form = ob_get_clean();
--         end; else then
--                 // Build a string containing an aria-label to use for the search form.
--                 if ( args["aria_label"] ) then
...
-- --
-- function wp_loginout( redirect = "", echo = true ) then
...
-- --
-- function wp_login_form( args = array() ) then
--         defaults = array(
--                 "echo"           => true,
...
--         form =
--                 sprintf(
--                         "<form name="%1s" id="%1s" action="%2s" method="post">",
...
--                                 <input type="text" name="log" id="%1s" autocomplete="username" class="input" value="%3s" size="20" />
--                         </p>",
...
--                                 <label for="%1s">%2s</label>
--                                 <input type="password" name="pwd" id="%1s" autocomplete="current-password" class="input" value="" size="20" />
--                         </p>",
...
--                 ( args["remember"] ?
--                         sprintf(
--                                 "<p class="login-remember"><label><input name="rememberme" type="checkbox" id="%1s" value="forever"%2s /> %3s</label></p>",
...
--                                 <input type="submit" name="wp-submit" id="%1s" class="button button-primary" value="%2s" />
--                                 <input type="hidden" name="redirect_to" value="%3s" />
--                         </p>",
...
-- --                     if `echo` is false.
-- --
-- function wp_register( before = "<li>", after = "</li>", echo = true ) then
--         if ( ! is_user_logged_in() ) then
...
--                         link = "";
--                 end;
--         end; elseif ( current_user_can( "read" ) ) then
...
--                                         __( "The %1s option is deprecated for the family of %2s functions. Use the %3s option instead." ),
--                                         "<code>" . show . "</code>",
--                                         "<code>bloginfo()</code>",
--                                         "<code>url</code>"
--                                 )
...
--                                         __( "The %1s option is deprecated for the family of %2s functions. Use the %3s function instead." ),
--                                         "<code>" . show . "</code>",
--                                         "<code>bloginfo()</code>",
--                                         "<code>is_rtl()</code>"
--                                 )
--                         );
--                         if ( function_exists( "is_rtl" ) ) then
...
--                 strpos( show, "home" ) === false ) then
--                 url = false;
--         end;

--         if ( "display" === filter ) then
--                 if ( url ) then
--                         --
...
-- -- @param int    blog_id Optional. ID of the blog to get the site icon for. Default current blog.
-- --
-- function site_icon_url( size = 512, url = "", blog_id = 0 ) then
...
-- --
-- function has_custom_logo( blog_id = 0 ) then
--         switched_blog = false;
...
-- --
-- function get_custom_logo( blog_id = 0 ) then
--         html          = "";
--         switched_blog = false;
...
--                 if ( unlink_homepage_logo && is_front_page() && ! is_paged() ) then
--                         /*
...
--                         html = sprintf(
--                                 "<span class="custom-logo-link">%1s</span>",
--                                 image
--                         );
--                 end; else then
...
--                         html = sprintf(
--                                 "<a href="%1s" class="custom-logo-link" rel="home"%2s>%3s</a>",
--                                 esc_url( home_url( "/" ) ),
--                                 aria_current,
--                                 image
--                         );
--                 end;
--         end; elseif ( is_customize_preview() ) then
--                 // If no logo is set but we"re in the Customizer, leave a placeholder (needed for the live preview).
--                 html = sprintf(
--                         "<a href="%1s" class="custom-logo-link" style="display:none;"><img class="custom-logo" alt="" /></a>",
--                         esc_url( home_url( "/" ) )
--                 );
--         end;
...
-- -- @param int blog_id Optional. ID of the blog in question. Default is the ID of the current blog.
-- --
-- function the_custom_logo( blog_id = 0 ) then
...
-- --
-- function wp_title( sep = "&raquo;", display = true, seplocation = "" ) then
--         global wp_locale;
...
--         // If there is a post.
--         if ( is_single() || ( is_home() && ! is_front_page() ) || ( is_page() && ! is_front_page() ) ) then
...
--                 if ( ! post_type_object->has_archive ) then
--                         title = post_type_archive_title( "", false );
--                 end;
--         end;

--         // If there"s a category or tag.
--         if ( is_category() || is_tag() ) then
...
--         if ( is_author() && ! is_post_type_archive() ) then
...
--         if ( is_post_type_archive() && post_type_object->has_archive ) then
--                 title = post_type_archive_title( "", false );
--         end;

--         // If there"s a month.
--         if ( is_archive() && ! empty( m ) ) then
...
--         // If there"s a year.
--         if ( is_archive() && ! empty( year ) ) then
--                 title = year;
--                 if ( ! empty( monthnum ) ) then
...
--                 title = sprintf( __( "Search Results %1s %2s" ), t_sep, strip_tags( search ) );
--         end;
...
--         if ( "right" === seplocation ) then // Separator on right, so reverse the order.
...
-- --
-- function single_cat_title( prefix = "", display = true ) then
...
-- --
-- function single_month_title( prefix = "", display = true ) then
--         global wp_locale;
...
--         if ( ! empty( monthnum ) && ! empty( year ) ) then
--                 my_year  = year;
--                 my_month = wp_locale->get_month( monthnum );
--         end; elseif ( ! empty( m ) ) then
--                 my_year  = substr( m, 0, 4 );
--                 my_month = wp_locale->get_month( substr( m, 4, 2 ) );
--         end;

--         if ( empty( my_month ) ) then
--                 return false;
--         end;
...
-- --
-- function the_archive_title( before = "", after = "" ) then
...
-- --
-- function get_the_archive_title() then
--         title  = __( "Archives" );
--         prefix = "";
...
--         end; elseif ( is_tax( "post_format" ) ) then
--                 if ( is_tax( "post_format", "post-format-aside" ) ) then
--                         title = _x( "Asides", "post format archive title" );
--                 end; elseif ( is_tax( "post_format", "post-format-gallery" ) ) then
--                         title = _x( "Galleries", "post format archive title" );
--                 end; elseif ( is_tax( "post_format", "post-format-image" ) ) then
--                         title = _x( "Images", "post format archive title" );
--                 end; elseif ( is_tax( "post_format", "post-format-video" ) ) then
--                         title = _x( "Videos", "post format archive title" );
--                 end; elseif ( is_tax( "post_format", "post-format-quote" ) ) then
--                         title = _x( "Quotes", "post format archive title" );
--                 end; elseif ( is_tax( "post_format", "post-format-link" ) ) then
--                         title = _x( "Links", "post format archive title" );
--                 end; elseif ( is_tax( "post_format", "post-format-status" ) ) then
--                         title = _x( "Statuses", "post format archive title" );
--                 end; elseif ( is_tax( "post_format", "post-format-audio" ) ) then
--                         title = _x( "Audio", "post format archive title" );
--                 end; elseif ( is_tax( "post_format", "post-format-chat" ) ) then
...
-- --
-- function the_archive_description( before = "", after = "" ) then
...
-- --
-- function get_the_archive_description() then
--         if ( is_author() ) then
...
-- --
-- function get_the_post_type_description() then
--         post_type = get_query_var( "post_type" );
...
--         if ( isset( post_type_obj->description ) ) then
...
-- --
-- function get_archives_link( url, text, format = "html", before = "", after = "", selected = false ) then
...
-- --
-- function wp_get_archives( args = "" ) then
...
--         if ( "" === parsed_args["type"] ) then
--                 parsed_args["type"] = "monthly";
--         end;

--         if ( ! empty( parsed_args["limit"] ) ) then
...
--         if ( "monthly" === parsed_args["type"] ) then
...
--                         foreach ( (array) results as result ) then
--                                 url = get_month_link( result->year, result->month );
--                                 if ( "post" !== parsed_args["post_type"] ) then
--                                         url = add_query_arg( "post_type", parsed_args["post_type"], url );
--                                 end;
--                                 /* translators: 1: Month name, 2: 4-digit year.--
--                                 text = sprintf( __( "%1s %2d" ), wp_locale->get_month( result->month ), result->year );
--                                 if ( parsed_args["show_post_count"] ) then
...
--                         end;
--                 end;
--         end; elseif ( "yearly" === parsed_args["type"] ) then
...
--                         end;
--                 end;
--         end; elseif ( "daily" === parsed_args["type"] ) then
...
--                                         url = add_query_arg( "post_type", parsed_args["post_type"], url );
--                                 end;
--                                 date = sprintf( "%1d-%202d-%302d 00:00:00", result->year, result->month, result->dayofmonth );
...
--                         end;
--                 end;
--         end; elseif ( "weekly" === parsed_args["type"] ) then
...
--                         after = parsed_args["after"];
--                         foreach ( (array) results as result ) then
--                                 if ( result->week != arc_w_last ) then
--                                         arc_year       = result->yr;
...
--                         end;
--                 end;
--         end; elseif ( ( "postbypost" === parsed_args["type"] ) || ( "alpha" === parsed_args["type"] ) ) then
...
--                 if ( results ) then
--                         foreach ( (array) results as result ) then
--                                 if ( "0000-00-00 00:00:00" !== result->post_date ) then
--                                         url = get_permalink( result );
--                                         if ( result->post_title ) then
...
-- --
-- function calendar_week_mod( num ) then
--         base = 7;
...
-- --
-- function get_calendar( initial = true, echo = true ) then
--         global wpdb, m, monthnum, year, wp_locale, posts;

--         key   = md5( m . monthnum . year );
--         cache = wp_cache_get( "get_calendar", "calendar" );

--         if ( cache && is_array( cache ) && isset( cache[ key ] ) ) then
--                 -- This filter is documented in wp-includes/general-template.php--
...
--                 thisyear  = (int) year;
--         end; elseif ( ! empty( w ) ) then
--                 // We need to get the month from MySQL.
--                 thisyear = (int) substr( m, 0, 4 );
--                 // It seems MySQL"s weeks disagree with PHP"s.
--                 d         = ( ( w - 1 )-- 7 ) + 6;
--                 thismonth = wpdb->get_var( "SELECT DATE_FORMAT((DATE_ADD("thenthisyearend;0101", INTERVAL d DAY) ), "%m")" );
--         end; elseif ( ! empty( m ) ) then
--                 thisyear = (int) substr( m, 0, 4 );
--                 if ( strlen( m ) < 6 ) then
--                         thismonth = "01";
...
--                 "SELECT MONTH(post_date) AS month, YEAR(post_date) AS year
--                 FROM wpdb->posts
--                 WHERE post_date > "thisyear-thismonth-thenlast_dayend; 23:59:59"
--                 AND post_type = "post" AND post_status = "publish"
...
--         calendar_caption = _x( "%1s %2s", "calendar caption" );
...
--         for ( wdcount = 0; wdcount <= 6; wdcount++ ) then
--                 myweek[] = wp_locale->get_weekday( ( wdcount + week_begins ) % 7 );
--         end;

--         foreach ( myweek as wd ) then
...
--                 FROM wpdb->posts WHERE post_date >= "thenthisyearend;-thenthismonthend;-01 00:00:00"
--                 AND post_type = "post" AND post_status = "publish"
--                 AND post_date <= "thenthisyearend;-thenthismonthend;-thenlast_dayend; 23:59:59"",
--                 ARRAY_N
--         );

--         if ( dayswithposts ) then
--                 foreach ( (array) dayswithposts as daywith ) then
...
--         for ( day = 1; day <= daysinmonth; ++day ) then
--                 if ( isset( newrow ) && newrow ) then
--                         calendar_output .= "\n\t</tr>\n\t<tr>\n\t\t";
--                 end;
--                 newrow = false;
...
--                         current_time( "Y" ) == thisyear ) then
--                         calendar_output .= "<td id="today">";
--                 end; else then
--                         calendar_output .= "<td>";
--                 end;

--                 if ( in_array( day, daywithpost, true ) ) then
--                         // Any posts today?
--                         date_format = gmdate( _x( "F j, Y", "daily archives date format" ), strtotime( "thenthisyearend;-thenthismonthend;-thendayend;" ) );
...
--                 if ( 6 == calendar_week_mod( gmdate( "w", mktime( 0, 0, 0, thismonth, day, thisyear ) ) - week_begins ) ) then
--                         newrow = true;
--                 end;
--         end;
...
-- -- @since 2.1.0
-- --
-- function delete_get_calendar_cache() then
...
-- --
-- function allowed_tags() then
--         global allowedtags;
--         allowed = "";
--         foreach ( (array) allowedtags as tag => attributes ) then
--                 allowed .= "<" . tag;
--                 if ( 0 < count( attributes ) ) then
--                         foreach ( attributes as attribute => limits ) then
--                                 allowed .= " " . attribute . "=""";
--                         end;
--                 end;
--                 allowed .= "> ";
...
-- --
-- function the_date( format = "", before = "", after = "", echo = true ) then
...
-- -- @return string|void String if retrieving.
-- --
-- function the_modified_date( format = "", before = "", after = "", echo = true ) then
...
-- --
-- function get_the_modified_date( format = "", post = null ) then
--         post = get_post( post );
...
-- --
-- function get_post_timestamp( post = null, field = "date" ) then
...
-- --                       Defaults to the "time_format" option.
-- --
-- function the_modified_time( format = "" ) then
--         --
...
-- --
-- function get_the_modified_time( format = "", post = null ) then
--         post = get_post( post );
...
-- --                          False on failure.
-- --
-- function get_post_modified_time( format = "U", gmt = false, post = null, translate = false ) then
--         post = get_post( post );
...
-- -- @param string after  Optional. Output after the date. Default empty.
-- --
-- function the_weekday_date( before = "", after = "" ) then
...
--         if ( currentday !== previousweekday ) then
...
-- -- @since 2.3.1
-- --
-- function wlwmanifest_link() then
--         printf(
...
-- --
-- function wp_site_icon() then
--         if ( ! has_site_icon() && ! is_customize_preview() ) then
--                 return;
--         end;

--         meta_tags = array();
--         icon_32   = get_site_icon_url( 32 );
--         if ( empty( icon_32 ) && is_customize_preview() ) then
...
--         foreach ( meta_tags as meta_tag ) then
--                 echo "meta_tag\n";
--         end;
-- end;
...
-- --
-- function user_can_richedit() then
--         global wp_rich_edit, is_gecko, is_opera, is_safari, is_chrome, is_IE, is_edge;

--         if ( ! isset( wp_rich_edit ) ) then
--                 wp_rich_edit = false;

--                 if ( "true" === get_user_option( "rich_editing" ) || ! is_user_logged_in() ) then // Default to "true" for logged out users.
--                         if ( is_safari ) then
--                                 wp_rich_edit = ! wp_is_mobile() || ( preg_match( "!AppleWebKit/(\d+)!", _SERVER["HTTP_USER_AGENT"], match ) && (int) match[1] >= 534 );
--                         end; elseif ( is_IE ) then
--                                 wp_rich_edit = ( strpos( _SERVER["HTTP_USER_AGENT"], "Trident/7.0;" ) !== false );
--                         end; elseif ( is_gecko || is_chrome || is_edge || ( is_opera && ! wp_is_mobile() ) ) then
--                                 wp_rich_edit = true;
--                         end;
--                 end;
--         end;
...
-- --
-- function wp_default_editor() then
--         r = user_can_richedit() ? "tinymce" : "html"; // Defaults.
--         if ( wp_get_current_user() ) then // Look for cookie.
...
-- --
-- function wp_editor( content, editor_id, settings = array() ) then
--         if ( ! class_exists( "_WP_Editors", false ) ) then
...
-- -- @since 4.8.0
-- --
-- function wp_enqueue_editor() then
--         if ( ! class_exists( "_WP_Editors", false ) ) then
--                 require ABSPATH . WPINC . "/class-wp-editor.php";
--         end;
...
-- --
-- function wp_enqueue_code_editor( args ) then
--         if ( is_user_logged_in() && "false" === wp_get_current_user()->syntax_highlighting ) then
--                 return false;
--         end;

--         settings = wp_get_code_editor_settings( args );

--         if ( empty( settings ) || empty( settings["codemirror"] ) ) then
--                 return false;
--         end;
...
--         if ( isset( settings["codemirror"]["mode"] ) ) then
--                 mode = settings["codemirror"]["mode"];
--                 if ( is_string( mode ) ) then
--                         mode = array(
--                                 "name" => mode,
--                         );
--                 end;

--                 if ( ! empty( settings["codemirror"]["lint"] ) ) then
--                         switch ( mode["name"] ) then
--                                 case "css":
--                                 case "text/css":
--                                 case "text/x-scss":
--                                 case "text/x-less":
...
-- --
-- function wp_get_code_editor_settings( args ) then
--         settings = array(
--                 "codemirror" => array(
--                         "indentUnit"       => 4,
--                         "indentWithTabs"   => true,
...
--                 if ( "application/x-patch" === type || "text/x-patch" === type ) then
--                         type = "text/x-diff";
--                 end;
--         end; elseif ( isset( args["file"] ) && false !== strpos( basename( args["file"] ), "." ) ) then
...
--         if ( in_array( type, array( "text/css", "text/x-scss", "text/x-less", "text/x-sass" ), true ) ) then
...
--                         )
--                 );
--         end; elseif ( "text/x-diff" === type ) then
--                 settings["codemirror"] = array_merge(
--                         settings["codemirror"],
--                         array(
--                                 "mode" => "diff",
--                         )
--                 );
--         end; elseif ( "text/html" === type ) then
--                 settings["codemirror"] = array_merge(
--                         settings["codemirror"],
--                         array(
--                                 "mode"              => "htmlmixed",
...
--                 end;
--         end; elseif ( "text/x-gfm" === type ) then
--                 settings["codemirror"] = array_merge(
--                         settings["codemirror"],
--                         array(
--                                 "mode"                => "gfm",
...
--                         )
--                 );
--         end; elseif ( "application/javascript" === type || "text/javascript" === type ) then
--                 settings["codemirror"] = array_merge(
--                         settings["codemirror"],
--                         array(
--                                 "mode"              => "javascript",
...
--                         )
--                 );
--         end; elseif ( false !== strpos( type, "json" ) ) then
--                 settings["codemirror"] = array_merge(
--                         settings["codemirror"],
--                         array(
--                                 "mode"              => array(
...
--                         )
--                 );
--         end; elseif ( "text/x-markdown" === type ) then
--                 settings["codemirror"] = array_merge(
--                         settings["codemirror"],
--                         array(
--                                 "mode"                => "markdown",
...
--                         )
--                 );
--         end; elseif ( "text/nginx" === type ) then
--                 settings["codemirror"] = array_merge(
--                         settings["codemirror"],
--                         array(
--                                 "mode" => "nginx",
--                         )
--                 );
--         end; elseif ( "application/x-httpd-php" === type ) then
--                 settings["codemirror"] = array_merge(
--                         settings["codemirror"],
--                         array(
--                                 "mode"              => "php",
...
--                         )
--                 );
--         end; elseif ( "text/x-sql" === type || "text/x-mysql" === type ) then
--                 settings["codemirror"] = array_merge(
--                         settings["codemirror"],
--                         array(
--                                 "mode"              => "sql",
...
--                         )
--                 );
--         end; elseif ( false !== strpos( type, "xml" ) ) then
--                 settings["codemirror"] = array_merge(
--                         settings["codemirror"],
--                         array(
--                                 "mode"              => "xml",
...
--                         )
--                 );
--         end; elseif ( "text/x-yaml" === type ) then
--                 settings["codemirror"] = array_merge(
--                         settings["codemirror"],
--                         array(
--                                 "mode" => "yaml",
...
--         foreach ( wp_array_slice_assoc( args, array( "codemirror", "csslint", "jshint", "htmlhint" ) ) as key => value ) then
...
-- -- @since 2.1.0
-- --
-- function the_search_query() then
--         --
...
-- -- end;
-- --
-- function wp_admin_css_color( key, name, url, colors = array(), icons = array() ) then
--         global _wp_admin_css_colors;

--         if ( ! isset( _wp_admin_css_colors ) ) then
...
-- -- @since 3.0.0
-- --
-- function register_admin_color_schemes() then
--         suffix  = is_rtl() ? "-rtl" : "";
...
--                 admin_url( "css/colors/light/colorssuffix.css" ),
...
--                 admin_url( "css/colors/modern/colorssuffix.css" ),
...
--                 admin_url( "css/colors/blue/colorssuffix.css" ),
...
--                 admin_url( "css/colors/midnight/colorssuffix.css" ),
...
--                 admin_url( "css/colors/sunrise/colorssuffix.css" ),
...
--                 admin_url( "css/colors/ectoplasm/colorssuffix.css" ),
...
--                 admin_url( "css/colors/ocean/colorssuffix.css" ),
...
--                 admin_url( "css/colors/coffee/colorssuffix.css" ),
...
-- --
-- function the_generator( type ) then
--         --
...
-- --
-- function get_the_generator( type = "" ) then
--         if ( empty( type ) ) then

--                 current_filter = current_filter();
--                 if ( empty( current_filter ) ) then
--                         return;
--                 end;
...
-- -- @return string HTML attribute or empty string.
-- --
-- function wp_readonly( readonly, current = true, echo = true ) then
...
-- --
-- function wp_heartbeat_settings( settings ) then
--         if ( ! is_admin() ) then
