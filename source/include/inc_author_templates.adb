...
-- --
-- function get_the_author( deprecated = "" ) then
--         global authordata;
...
-- --
-- function the_author( deprecated = "", deprecated_echo = true ) then
--         if ( ! empty( deprecated ) ) then
--                 _deprecated_argument( __FUNCTION__, "2.1.0" );
--         end;
...
-- --
-- function get_the_modified_author() then
...
-- -- @see get_the_author()
-- --
-- function the_modified_author() then
...
-- --
-- function the_author_meta( field = "", user_id = false ) then
...
--         --
--         echo apply_filters( "the_author_thenfieldend;", author_meta, user_id );
-- end;
...
-- --
-- function get_the_author_link() then
--         if ( get_the_author_meta( "url" ) ) then
--                 global authordata;
...
--                 link = sprintf(
--                         "<a href="%1s" title="%2s" rel="author external">%3s</a>",
--                         esc_url( author_url ),
...
-- --
-- function get_the_author_posts() then
--         post = get_post();
--         if ( ! post ) then
--                 return 0;
--         end;
...
-- -- @since 0.71
-- --
-- function the_author_posts() then
...
-- --
-- function get_the_author_posts_link() then
--         global authordata;
--         if ( ! is_object( authordata ) ) then
--                 return "";
--         end;

--         link = sprintf(
--                 "<a href="%1s" title="%2s" rel="author">%3s</a>",
...
-- --
-- function the_author_posts_link( deprecated = "" ) then
--         if ( ! empty( deprecated ) ) then
--                 _deprecated_argument( __FUNCTION__, "2.1.0" );
--         end;
...
-- --
-- function get_author_posts_url( author_id, author_nicename = "" ) then
--         global wp_rewrite;
...
--         end; else then
--                 if ( "" === author_nicename ) then
--                         user = get_userdata( author_id );
--                         if ( ! empty( user.user_nicename ) ) then
...
-- --
-- function wp_list_authors( args = "" ) then
--         global wpdb;
...
--                 foreach ( (array) post_counts as row ) then
--                         post_counts[ row.post_author ] = row.count;
--                 end;
--         end;

--         foreach ( authors as author_id ) then
--                 posts = isset( post_counts[ author_id ] ) ? post_counts[ author_id ] : 0;

--                 if ( ! posts && parsed_args["hide_empty"] ) then
--                         continue;
--                 end;

--                 author = get_userdata( author_id );

--                 if ( parsed_args["exclude_admin"] && "admin" === author.display_name ) then
--                         continue;
--                 end;

--                 if ( parsed_args["show_fullname"] && author.first_name && author.last_name ) then
--                         name = sprintf(
...
--                 if ( parsed_args["optioncount"] ) then
--                         link .= " (" . posts . ")";
--                 end;
...
-- --
-- function is_multi_author() then
--         global wpdb;

--         is_multi_author = get_transient( "is_multi_author" );
--         if ( false === is_multi_author ) then
...
-- -- @access private
-- --
-- function __clear_multi_author_cache() then // phpcs:ignore WordPress.NamingConventions.ValidFunctionName.FunctionDoubleUnderscore,PHPCompatibility.FunctionNameRestrictions.ReservedFunctionNames.FunctionDoubleUnderscore
