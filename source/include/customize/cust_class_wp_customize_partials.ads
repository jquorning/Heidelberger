...
package Cust_Class_Wp_Customize_Partials
is
   use Arrays;
   ...
   type Wp_Customize_Partial is tagged
      record
         --
         -- Component.
         --
...
--         public settings;
         ...
         --
         -- The ID for the setting that this partial is primarily responsible for
         -- rendering.
         --
...
--         public capability;
         ...
         --               partial or return the partial as a string, or return false
         --               if error.
         --
--         public render_callback;

         --
         -- Whether the container element is included in the partial, or if only the
...
--         public container_inclusive = false;
         ...
         --
         -- Whether to refresh the entire preview in case a partial cannot be
         -- refreshed.
         --
...
--         public fallback_refresh = true;
        ...
        -- -- end;
        -- --
        -- public function __construct( WP_Customize_Selective_Refresh component, id, args = array() ) then
        ...
        --         if ( empty( this.render_callback ) ) then
        ...
        --         if ( empty( this.primary_setting ) ) then
   ...
   function Id_Data (This : Wp_Customize_Partial)
        ...
        -- --
        -- final public function render( container_context = array() ) then
        --         partial  = this;
        --         rendered = false;
        ...
        --                 if ( null !== return_render && "" !== ob_render ) then
        ...
        --         --                                                the target container.
        --         --
        --         rendered = apply_filters( "customize_partial_render_thenpartial.idend;", rendered, partial, container_context );
        ...
        -- --
        -- public function render_callback( WP_Customize_Partial partial, context = array() ) then
        ...
        --                 return false;
        --         end;
        --         foreach ( this.settings as setting_id ) then
